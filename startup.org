...
** Thought Stack
   ...
   #+begin_src emacs-lisp :tangle no :noweb yes :noweb-ref thought-stack :lexical t
     ...
     Saves the window configuration that's active now."
       (interactive "sPush: ")
       (push (cons concept (current-window-configuration)) thought-stack))
     ...
     the thought."
       ...
       (let ((thought (pop thought-stack)))
         (if thought
             (progn
               (set-window-configuration (cdr thought))
...
** Swift
   I'm working on a project that has an iOS app.  I'm adding support
   for Swift files.
