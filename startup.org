...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref q-skeletons :lexical t
  (define-skeleton quiescent-common-lisp-skeleton-advent-of-code
      ...
      "        (input-2 '())\n"
      "        (expected-2 '()))\n"
      "    (format t \"Part 1: Expected: ~s\n    Got:      ~s\" expected-1 ("quiescent-module-name "-part-1 input-1))\n"
      "    (format t \"Part 2: Expected: ~s\n    Got:      ~s\" expected-2 ("quiescent-module-name "-part-2 input-2))))\n"
      "\n"
      ";; Run the solution:\n"
      "\n"
      "(progn\n"
      ...
      "    (format t \"Part 1: ~s\n\" ("quiescent-module-name "-part-1 input-1))\n"
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref load-org :lexical t
  ...
  (setq org-capture-templates
        (quote (("p" "Programming Notes" entry (file "~/notes/programming.org")
                     "* %? \n%U\n%a\n")
                ("s" "Social" entry (file "~/notes/social.org")
                     "* %? \n%U\n%a\n"))))
