...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref windows-super-key :exports none :lexical t
  (if running-windows
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref system-specific-tasks :exports none :lexical t
  (use-package system-specific-tasks
    :load-path "~/.emacs.d/system-specific-tasks/")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref system-specific-config :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref other-window :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref buffer-disjunction :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref this-but-not-that :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref tiny-mode :exports none :lexical t
  (use-package tiny
      :ensure t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref hippie-expand :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref avy :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref mark-and-pop :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref ensure-pop-moves :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref visual-marks :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref auto-highlight-symbol :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref hydra :exports none :lexical t
  (use-package hydra
    :ensure t
    :config
    (progn
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref hydra-drawing :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref code-explorer :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref window-jump :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref isearch-kill :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref isearch-first-last-hit :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref iy-mods :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref quiescent-cross-link :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref multiple-cursors :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref iedit :exports none :lexical t
  (use-package iedit
      :ensure t
      :bind ("M-s ," . iedit-mode))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref hiscroll :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref general-recursive-session :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref composable :exports none :lexical t
  (use-package composable
    :ensure t
    :init (composable-mode)
    :config (composable-mark-mode))
#+END_SRC

** Completion Setup
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref completion :exports none :lexical t
  <<company-mode>>
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref company-mode :exports none :lexical t
  (use-package company
   :ensure t
   :init
   (progn
     (add-hook 'prog-mode-hook        #'quiescent-activate-company-mode)
     ;; TODO: this would be awesome if it had everything.
     ;; (add-hook 'minibuffer-setup-hook #'quiescent-activate-company-mode)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref company-no-semantic-in-jsx :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref company-text-mode-backends :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref company-statistics :exports none :lexical t
  ...
  (use-package company-statistics
   :ensure t
   :config
   (add-hook 'company-mode-hook #'quiescent-activate-company-statistics))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref eacl :exports none :lexical t
  (eval-and-compile
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref matt-is-watching :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref realgud :exports none :lexical t
  (use-package realgud
      :ensure t)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref clean-file :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref compile :exports none :lexical t
  (require 'compile)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref flycheck :exports none :lexical t
  ;; TODO more carefully consider which modes need flycheck
  (use-package flycheck
      :ensure t
      :init (progn
              (add-hook 'prog-mode-hook     #'quiescent-enable-flycheck-prog)
              (add-hook 'latex-mode-hook    #'quiescent-enable-flycheck)
              (add-hook 'message-mode-hook  #'quiescent-enable-flycheck)
              (add-hook 'org-mode-hook      #'quiescent-enable-flycheck)
              (add-hook 'text-mode-hook     #'quiescent-enable-flycheck)
              (add-hook 'gfm-mode           #'quiescent-enable-flycheck)
              (add-hook 'markdown-mode-hook #'quiescent-enable-flycheck)
              (add-hook 'LaTeX-mode-hook    #'quiescent-enable-flycheck)))
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref flymake :exports none :lexical t
  (require 'flymake)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref hide-show :exports none :lexical t
  ...
  (use-package hideshow
      ...
      :config (progn
                ...
                (add-hook 'sgml-mode            'hs-minor-mode)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref paren :exports none :lexical t
  (use-package paren
      :config (progn
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref yasnippet :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref company-or-yas-on-tab :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref q-skeletons :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref paredit :exports none :lexical t
  (use-package paredit
    :ensure t
    :config (progn
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref electric-pair :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref save-place :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref fancy-narrow :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref emacs-refactor :exports none :lexical t
  (use-package emr
   :ensure t
   :config
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref temp-view :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref temp-view-format-eshell :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref compilation-regexps :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref random-data-here :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref editor-config :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref eval-on-save :exports none :lexical t
  (use-package eros
    :ensure t)
...
#+BEGIN_SRC emacs-lisp  :tangle no :noweb yes :noweb-ref too-long-lines :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref ediff-accept-both :exports none :lexical t
  (require 'ediff)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref helm :exports none :lexical t
  ...
  (use-package helm
      ...
      :config (quiescent-configure-helm))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref sneaky-shells :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :exports none :tangle no :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref shells-setup :exports none :lexical t
  (require 'cl-lib)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref shell-here :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref compilation-minor-mode-key :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref eshell-setup :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref eshell-compilation-minor-mode :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref eshell-company-autosuggest :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref eshell-company-autosuggest-fix-candidates :exports none :lexical t
  (require 'em-hist)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref project-find-file-two-step :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref project-find-file :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref project-find-file-other-window :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref project-settings :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref etags-tag-search :exports none :lexical t
  (require 'thingatpt)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref project-command-at-interval :exports none :lexical t
  (eval-and-compile
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref goto-chg :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref vc-git-grep :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref idutils :exports none :lexical t
  (eval-and-compile
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref backup-files :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref gtags :exports none :lexical t
  (defvar install-ggtags
    (lambda ()
      `(use-package ggtags
         :ensure t
         :config (add-hook 'scala-mode-hook (lambda () (ggtags-mode 1)))))
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref smartscan :exports none :lexical t
  (use-package smartscan
    :ensure t
    :init (progn
            (add-hook 'prog-mode-hook 'quiescent-smartscan-enable)
            (add-hook 'org-mode-hook  'quiescent-smartscan-enable))
    :config (progn
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref wgrep :exports none :lexical t
  (use-package wgrep
   :ensure t)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref read-only :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref go-up :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref increment-number-at-point :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref recentf-mode :exports none :lexical t
  (require 'recentf)
  ...
  (use-package recentf
    ...
    :config (progn
              ...
              (add-to-list 'quiescent-post-load-hooks
                 #'recentf-open-files)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref recentf-ext :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref icomplete-bindings :exports none :lexical t
  (require 'icomplete)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref icomplete-show-all-the-time :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref ignore-regex-case :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref keyboard-macros :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref string-replacement :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref julia :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref yaml :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref groovy :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref c-mode :exports none :lexical t
  (require 'cc-mode)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref plantuml :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref fsharp :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref graphviz-dot :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref web-mode :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref sass :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref rjsx :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref powershell :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref haskell :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref cython :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref nxml-mode :exports none :lexical t
  (require 'nxml-mode)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref sql-indent :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref sql :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref maven :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref eslint-fix-mode :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref fix-linting-at-point :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref js2-highlight-var-at-point :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref js2-highlight-var-at-point-fix-timer :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref js2-mode-extras :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref typescript :exports none :lexical t
  <<tide>>
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref tide :exports none :lexical t
  (use-package tide
   :ensure t
   :init
  ...
  (defun quiescent-setup-tide-mode ()
    ...
    (progn
      ...
      (add-hook 'js2-mode #'tide-mode)
      (add-hook 'js2-jsx-mode #'tide-mode)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref rust :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref slime :exports none :lexical t
  (use-package slime
   :ensure t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref cider :exports none :lexical t
  (use-package cider
      :ensure t
      :init (progn
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref emacs-lisp :exports none :lexical t
  <<macrostep>>
  <<debug-signals>>
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref macrostep :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref debug-signals :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref scala :exports none :lexical t
  <<ensime-yasnippet>>
  <<scala-tags>>
  <<scala-edit-string>>
  ...
  (use-package ensime
      ...
      :config (progn
                ...
                (advice-add 'ensime-edit-definition :after #'quiescent-pulse-line)
                (setq ensime-startup-notification nil)))

  (defun quiescent-pulse-line (&rest _)
    "Pulse the current line for effect."
    (xref-pulse-momentarily))

  (define-key ensime-mode-map (kbd "C-c C-r") #'quiescent-vc-git-grep)

  (defun janco-setup-root-dir-for-ensime-search ()
    "Setup `default-directory' as project root in `ensime-search-classic'."
    (setq default-directory (vc-git-root default-directory)))

  (advice-add #'ensime-search-classic :after
              #'janco-setup-root-dir-for-ensime-search)

  (defun quiescent-disable-flycheck-in-sbt-mode (&rest _)
    "Disable flycheck in sbt files."
    (when (string-match "\.sbt$" (buffer-file-name))
      (quiescent-disable-flycheck)))

  ;(add-hook 'scala-mode-hook #'quiescent-disable-flycheck-in-sbt-mode)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref ensime-yasnippet :exports none :lexical t
  (require 'yasnippet)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref scala-tags :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref scala-edit-string :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref dockerfile :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref gnus :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref e-reader :exports none none :lexical t
  (use-package ereader
    :ensure t)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref csv :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref ibuffer :exports none :lexical t
  (require 'ibuffer)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref isearchb :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref markdown :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref dired-mode :exports none :lexical t
    (use-package dired-x
    :config (progn
  ...
  (use-package dired-filter
    ...
    :config (setq dired-filter-group-saved-groups
                  '(("default"
                     ("PDF"
                      (extension . "pdf"))
                     ("LaTeX"
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref eww :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref load-org :exports none :lexical t
  ...
  (use-package org
      ...
      (progn
        ...
        (load-file "~/.emacs.d/org-settings/org-agenda-file-list.el")
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref org-bullets :exports none :lexical t
  (defun quiescent-activate-org-bullets-mode ()
    (org-bullets-mode 1))

  (use-package org-bullets
    :ensure t
    :init (add-hook 'org-mode-hook #'quiescent-activate-org-bullets-mode))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref org-beautify-theme :exports none :lexical t
...
#+BEGIN_SRC org :exports none :lexical t :tangle no
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref org-dependencies :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref org-reveal :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref htmlize :exports none :lexical t
  (use-package htmlize
      :ensure t)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref epresent :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref demo-it :exports none :lexical t
  (use-package demo-it
   :ensure t)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref org-tree-slide :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref magit-setup :exports none :lexical t
  (use-package magit
      :ensure t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref magit-insert-files :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref magit-forges :exports none :lexical t
  (use-package forge
      :ensure t)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref git-commands :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref chess :exports none :lexical t
  (use-package chess
      :ensure t)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref typing-game :exports none :lexical t
  (use-package typing
      :ensure t)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref slock :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref tramp :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref gnuplot :exports none :lexical t
  (use-package gnuplot
    :ensure t)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref 4clojure :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref 4clojure-convenience :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref track-4clojure-progress :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref 4clojure-correct-number :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref 4clojure-pickup :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref erc :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref bbdb :exports none :lexical t
  (use-package bbdb
    :ensure t
    :defer 10
    :init (progn
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref rest-client :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref linkd :exports none :lexical t
  (require 'wiki/linkd)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref ia-writer :exports none :lexical t
  (require 'cl-lib)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref auctex :exports none :lexical t
  (require 'ox-latex)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref editing :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref ispell :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref langtool :exports none :lexical t
...
* Controlling Emacs
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref controlling-emacs :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref async :exports none :lexical t
  (use-package async
      :ensure t)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref themes :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref rainbow-delims :exports none :lexical t
  ...
  (use-package rainbow-delimiters
   :ensure t
   :config
   (add-hook 'prog-mode-hook #'quiescent-activate-rainbow-delimiters-mode))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref page-break-lines :exports none :lexical t
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref prettify :exports none :lexical t
  ...
  (use-package prog-mode
   :init (progn
           ...
           (add-hook 'prog-mode-hook #'quiescent-activate-pretify-symbols-mode)
           (add-hook 'text-mode-hook #'quiescent-activate-pretify-symbols-mode)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref splash-screen :exports none
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref mb-depth :exports none :lexical t
