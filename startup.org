...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref company-statistics :lexical t
  (defun quiescent-activate-company-statistics ()
    ...
    (when (boundp 'company-statistics-mode)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref semantic :lexical t
  ...
  (setq semantic-default-submodes
        '(global-semantic-highlight-func-mode global-semantic-decoration-mode global-semantic-stickyfunc-mode global-semantic-idle-scheduler-mode global-semanticdb-minor-mode global-semantic-idle-local-symbol-highlight-mode global-semantic-highlight-edits-mode global-semantic-show-unmatched-syntax-mode))
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref scala :lexical t
  ...
  (add-hook 'scal-mode-hook #'quiescent-remove-flex)
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref pdf-tools :lexical t
  ...
  ;;     :config (define-key pdf-view-mode-map (kbd "M-w") #'pdf-view-kill-ring-save))
