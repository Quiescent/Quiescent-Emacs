...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref web-mode :lexical t
  ...
  (use-package company-web
    :ensure t
    :hook (html-mode . quiescent-setup-company-web-completion))
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :noweb-ref rjsx :lexical t
  (use-package rjsx-mode
   ...
   :hook (rjsx-mode . quiescent-disable-semantic-mode))
...
#+begin_src emacs-lisp :tangle no :noweb yes :noweb-ref perfect-margins :lexical t
  (use-package perfect-margin
    :ensure t
    :custom ((perfect-margin-visible-width 128)
             (perfect-margin-ignore-regexps '(".*minibuffer.*")))
    :config
