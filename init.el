...
(use-package perfect-margin
  ...
  (add-to-list 'perfect-margin-force-regexps "*Org Agenda*")
  (add-to-list 'perfect-margin-force-regexps "*helm"))
...
;; From the Emacs Wiki: https://emacswiki.org/emacs/AlarmBell

(setq visible-bell nil
      ring-bell-function 'flash-mode-line)
(defun flash-mode-line ()
  "Invert the mode line and then uninvert it a little later."
  (invert-face 'nano-modeline-active)
  (run-with-timer 0.1 nil #'invert-face 'nano-modeline-active))
...
;; I used helm ages ago.  I think it's time to switch back to it.  It
;; does a bunch of stuff better.  Posframe is the thing calling me
;; back at the moment, but there's also its support for recent files
;; and its interactive grepping system.
...
(defun quiescent-tide-flycheck-enabled-in-buffer ()
